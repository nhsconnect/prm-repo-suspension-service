...
public class SuspensionsDb {
    ...
    public LastUpdatedEvent getByNhsNumber(String nhsNumber) {
        ...
        key.put("nhs_number_key", AttributeValue.builder().s(nhsNumber).build());
    ...
    public void save(LastUpdatedEvent lastUpdatedEvent) {
        ...
        item.put("nhs_number_key", AttributeValue.builder().s(lastUpdatedEvent.getNhsNumber()).build());
    ...
    private LastUpdatedEvent fromDbItem(GetItemResponse itemResponse) {
        ...
        var nhsNumber = itemResponse.item().get("nhs_number_key").s();
