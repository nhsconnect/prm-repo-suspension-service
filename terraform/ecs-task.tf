locals {
  ...
  environment_variables = [
    ...
    { name = "INCOMING_QUEUE_NAME", value = var.is_end_of_transfer_service ? data.aws_ssm_parameter.transfer_complete_queue_name.value : aws_sqs_queue.suspensions.name },
